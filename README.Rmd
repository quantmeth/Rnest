...
```{r factstruct, echo = FALSE, out.height="50%", out.width="50%", fig.align='center'}
...
```{r plot, fig.cap="Scree plot of NEST", fig.align='center'}
res <- nest(mydata)
plot(res)
```
...
```{r plot2, fig.cap="Scree plot of NEST with many $\\alpha$", fig.align='center'}
